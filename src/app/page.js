...
//         <div className="mb-6">
//           <h1 className="text-3xl text-center font-semibold text-slate-900 tracking-tight">
//             Inventory Order
//           </h1>
...
//                 On submit, this order will be stored in Database.
//               </p>
//               <button
//                 type="submit"
//                 disabled={loading}
...
export default function page() {
  ...
  // suggestions per-row ke लिए helper
  const getSuggestions = (typed) => {
    if (!typed.trim()) return productNames;
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-5xl">
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm text-center mt-1">
            Log a new product order with multiple items and customer details.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.6fr,1.1fr] gap-6">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {items.map((item, index) => {
                const suggestions = getSuggestions(item.typedName);
                return (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateItem(index, "typedName", e.target.value) ||
                        ...
                        {suggestions.map((name) => (
                          <button
                            ...
                            onClick={() => {
                              ...
                              updateItem(index, "typedName", name);
                            }}
                            className={`text-xs rounded-full border px-3 py-1.5 transition
                            ${
            ...
            <div className="flex items-center justify-between pt-2">
              <p className="text-xs text-slate-500">
                On submit, this order (all items) will be stored in Database.
              </p>
              <button
                type="submit"
                disabled={loading}
          ...
          {/* simple side summary (first item + totals etc. chaaho to extend kar sakte ho) */}
          <div className="hidden lg:flex flex-col bg-white border border-slate-200 rounded-2xl px-5 py-5 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-900 mb-3">
              Current selection
            </h2>
            <div className="space-y-2 text-sm text-slate-700">
              <p>
                <span className="text-slate-500">Items:</span> {items.length}
              </p>
              <p>
